...
--
-- Host: localhost    Database: hardwaretesting
-- ------------------------------------------------------
...
CREATE TABLE `lookup` (
  ...
  KEY `idx_type` (`type`),
  KEY `idx_active` (`is_active`)
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Reference data for dropdowns and statuses';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lookup` VALUES (40,'category','UPVC Pipes','UPVC pipes for plumbing',1,1,'2026-02-14 11:37:11'),(41,'category','Electrical Conduit','Electrical conduit pipes',2,1,'2026-02-14 11:37:11'),(42,'category','Pressure Pipes','High pressure pipes',3,1,'2026-02-14 11:37:11'),(43,'category','Pipe Fittings','Various pipe fittings and connectors',4,1,'2026-02-14 11:37:11'),(44,'category','Electrical Fittings','Electrical accessories and fittings',5,1,'2026-02-14 11:37:11'),(45,'category','Tools','Hardware tools',6,1,'2026-02-14 11:37:11'),(46,'category','Adhesives','Glue, tape, adhesives',7,1,'2026-02-14 11:37:11'),(47,'category','Fasteners','Nails, screws, bolts',8,1,'2026-02-14 11:37:11'),(48,'category','Other','Miscellaneous items',9,1,'2026-02-14 11:37:11'),(49,'payment_status','Pending','Payment not received',1,1,'2026-02-14 11:37:11'),(50,'payment_status','Partial','Partially paid',2,1,'2026-02-14 11:37:11'),(51,'payment_status','Paid','Fully paid',3,1,'2026-02-14 11:37:11'),(52,'payment_status','Overdue','Payment overdue',4,1,'2026-02-14 11:37:11'),(53,'payment_status','Refunded','Payment refunded (for returns)',5,1,'2026-02-14 11:37:11'),(54,'order_status','Pending','Order placed, not received',1,1,'2026-02-14 11:37:11'),(55,'order_status','Partial','Partially received',2,1,'2026-02-14 11:37:11'),(56,'order_status','Completed','Fully received',3,1,'2026-02-14 11:37:11'),(57,'order_status','Cancelled','Order cancelled',4,1,'2026-02-14 11:37:11'),(58,'quotation_status','Draft','Quotation being prepared',1,1,'2026-02-14 11:37:11'),(59,'quotation_status','Sent','Quotation sent to customer',2,1,'2026-02-14 11:37:11'),(60,'quotation_status','Accepted','Customer accepted quotation',3,1,'2026-02-14 11:37:11'),(61,'quotation_status','Rejected','Customer rejected quotation',4,1,'2026-02-14 11:37:11'),(62,'quotation_status','Converted','Converted to bill',5,1,'2026-02-14 11:37:11'),(63,'quotation_status','Expired','Quotation expired',6,1,'2026-02-14 11:37:11'),(64,'return_status','Pending','Return initiated, not approved',1,1,'2026-02-14 11:37:11'),(65,'return_status','Approved','Return approved, stock restored',2,1,'2026-02-14 11:37:11'),(66,'return_status','Rejected','Return rejected',3,1,'2026-02-14 11:37:11'),(67,'return_status','Completed','Return completed, refund issued',4,1,'2026-02-14 11:37:11'),(68,'user_role','Admin','Full system access',1,1,'2026-02-14 11:37:11'),(69,'user_role','Manager','Management level access',2,1,'2026-02-14 11:37:11'),(70,'user_role','Cashier','Point of sale operator',3,1,'2026-02-14 11:37:11'),(71,'user_role','Inventory','Inventory management',4,1,'2026-02-14 11:37:11');
...
INSERT INTO `products` VALUES (12,'Elbow',43,'',7,1,1,'2026-03-10 19:06:31','2026-03-10 19:06:31'),(13,'pvc pipe',40,'great pipe',7,1,1,'2026-03-10 19:10:14','2026-03-10 19:10:14');
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Staff and user accounts';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `staff` VALUES (33,'Admin User','admin@bismillah.com','03001234567','3710012345671','Shop Address, Faisalabad',68,'admin','admin123',1,'2024-01-01','2026-03-10 18:52:51','2026-03-10 18:53:51',NULL);
...
INSERT INTO `supplier` VALUES (7,'abc developer','03039988787','lahore',0.00,1,'2026-03-10 19:04:48','2026-03-10 19:04:48','');
...
-- Dump completed on 2026-03-13 15:08:29
