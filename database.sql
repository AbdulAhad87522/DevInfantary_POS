...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bill line items - Stock REDUCED via trigger';
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bills/Invoices - REDUCES inventory when items added';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Quotation line items - Does NOT reduce stock';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Quotations - Does NOT affect inventory';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `return_items` VALUES (2,3,1,2.00,'Resalable'),(3,4,11,1.00,'Resalable'),(4,5,11,1.00,'Resalable'),(5,6,11,1.00,'Resalable');
...
INSERT INTO `returns` VALUES (3,15,1,'2026-02-21 06:17:26',690.50,26,'Product defective - customer complaint','Items inspected - approved for return','2026-02-21 06:17:26','2026-02-21 06:17:26'),(4,54,1,'2026-03-02 17:35:20',230.00,26,'not_as_described','w','2026-03-02 17:35:20','2026-03-02 17:35:20'),(5,55,1,'2026-03-02 17:39:05',238.00,26,'not_as_described','w','2026-03-02 17:39:05','2026-03-02 17:39:05'),(6,55,1,'2026-03-02 17:39:40',238.00,26,'wrong_item','z','2026-03-02 17:39:40','2026-03-02 17:39:40');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Supplier payment records for purchase batches';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-03 19:04:31
